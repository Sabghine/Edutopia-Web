 ...
 */
final class Version20210410112346 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE costudyingtype (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE activity CHANGE id_course id_course INT DEFAULT NULL');
        $this->addSql('ALTER TABLE co_studying CHANGE type type VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE co_studying ADD CONSTRAINT FK_5B8A12508CDE5729 FOREIGN KEY (type) REFERENCES costudyingtype (name)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE costudyingtype');
        $this->addSql('ALTER TABLE activity CHANGE id_course id_course INT NOT NULL');
        $this->addSql('DROP INDEX IDX_5B8A12508CDE5729 ON co_studying');
        $this->addSql('ALTER TABLE co_studying CHANGE type type VARCHAR(50) CHARACTER SET latin1 NOT NULL COLLATE `latin1_swedish_ci`');
