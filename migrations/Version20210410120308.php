 ...
 */
final class Version20210410120308 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE co_studying DROP FOREIGN KEY co_studying_ibfk_3');
        $this->addSql('ALTER TABLE co_studying DROP niveau, CHANGE type type VARCHAR(50) NOT NULL');
        $this->addSql('DROP INDEX type ON co_studying');
        $this->addSql('CREATE INDEX IDX_5B8A12508CDE5729 ON co_studying (type)');
        $this->addSql('ALTER TABLE co_studying ADD CONSTRAINT co_studying_ibfk_3 FOREIGN KEY (type) REFERENCES costudyingtype (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE co_studying ADD niveau VARCHAR(20) CHARACTER SET latin1 NOT NULL COLLATE `latin1_swedish_ci`, CHANGE type type INT NOT NULL');
        $this->addSql('DROP INDEX idx_5b8a12508cde5729 ON co_studying');
        $this->addSql('CREATE INDEX type ON co_studying (type)');
