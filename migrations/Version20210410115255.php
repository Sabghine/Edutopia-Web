 ...
 */
final class Version20210410115255 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE costudyingtype MODIFY id INT NOT NULL');
        $this->addSql('ALTER TABLE costudyingtype DROP PRIMARY KEY');
        $this->addSql('ALTER TABLE costudyingtype ADD PRIMARY KEY (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE costudyingtype MODIFY id INT NOT NULL');
        $this->addSql('ALTER TABLE costudyingtype DROP PRIMARY KEY');
        $this->addSql('ALTER TABLE costudyingtype ADD PRIMARY KEY (id, name)');
